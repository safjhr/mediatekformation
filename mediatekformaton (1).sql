...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 29 nov. 2024 à 17:08
...
('DoctrineMigrations\\Version20241012180435', '2024-10-12 18:05:34', 159);
...
(22, 'Cours Informatique embarqué', 'Présentation rapide de l\'informatique embarquée (14mn24).\r\n\r\nLien vers le pdf du cours :\r\nhttp://bit.ly/EmdsInformatique_embarquee'),
...
(1, 'admin', '[\"ROLE_ADMIN\"]', '$2y$13$hO.HD/6j/8u3IfAOt5LVB.qOeYhKQk7ZGHPR9iA2pGKvtzTGxcrWW'),
(3, 'safiya', '[\"ROLE_ADMIN\"]', '$2y$13$8w0HiqGDPwmC3T5J5eHw4eI6Y94FuO7aS7GO4euDt3fQBdsIL/2Ki');
